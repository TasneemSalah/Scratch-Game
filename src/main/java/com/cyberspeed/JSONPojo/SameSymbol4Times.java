...
public class SameSymbol4Times {
    ...
    public SameSymbol4Times withRewardMultiplier(Double rewardMultiplier) {
        this.rewardMultiplier = rewardMultiplier;
        return this;
    }
    ...
    public SameSymbol4Times withWhen(String when) {
        this.when = when;
        return this;
    }
    ...
    public SameSymbol4Times withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public SameSymbol4Times withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public SameSymbol4Times withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SameSymbol4Times.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SameSymbol4Times) == false) {
            return false;
        }
        SameSymbol4Times rhs = ((SameSymbol4Times) other);
