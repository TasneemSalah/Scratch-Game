...
public class _10x {
    ...
    public _10x withRewardMultiplier(Integer rewardMultiplier) {
        this.rewardMultiplier = rewardMultiplier;
        return this;
    }
    ...
    public _10x withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public _10x withImpact(String impact) {
        this.impact = impact;
        return this;
    }
    ...
    public _10x withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(_10x.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _10x) == false) {
            return false;
        }
        _10x rhs = ((_10x) other);
