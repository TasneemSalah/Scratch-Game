...
public class SameSymbol5Times {
    ...
    public SameSymbol5Times withRewardMultiplier(Integer rewardMultiplier) {
        this.rewardMultiplier = rewardMultiplier;
        return this;
    }
    ...
    public SameSymbol5Times withWhen(String when) {
        this.when = when;
        return this;
    }
    ...
    public SameSymbol5Times withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public SameSymbol5Times withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public SameSymbol5Times withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SameSymbol5Times.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SameSymbol5Times) == false) {
            return false;
        }
        SameSymbol5Times rhs = ((SameSymbol5Times) other);
