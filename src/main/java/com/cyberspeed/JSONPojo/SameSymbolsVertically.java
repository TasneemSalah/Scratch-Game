...
public class SameSymbolsVertically {
    ...
    public SameSymbolsVertically withRewardMultiplier(Integer rewardMultiplier) {
        this.rewardMultiplier = rewardMultiplier;
        return this;
    }
    ...
    public SameSymbolsVertically withWhen(String when) {
        this.when = when;
        return this;
    }
    ...
    public SameSymbolsVertically withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public SameSymbolsVertically withCoveredAreas(List<List<String>> coveredAreas) {
        this.coveredAreas = coveredAreas;
        return this;
    }
    ...
    public SameSymbolsVertically withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SameSymbolsVertically.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SameSymbolsVertically) == false) {
            return false;
        }
        SameSymbolsVertically rhs = ((SameSymbolsVertically) other);
