...
public class SameSymbol3Times {
    ...
    public SameSymbol3Times withRewardMultiplier(Integer rewardMultiplier) {
        this.rewardMultiplier = rewardMultiplier;
        return this;
    }
    ...
    public SameSymbol3Times withWhen(String when) {
        this.when = when;
        return this;
    }
    ...
    public SameSymbol3Times withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public SameSymbol3Times withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public SameSymbol3Times withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SameSymbol3Times.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SameSymbol3Times) == false) {
            return false;
        }
        SameSymbol3Times rhs = ((SameSymbol3Times) other);
