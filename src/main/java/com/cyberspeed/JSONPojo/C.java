...
public class C {
    ...
    public C withRewardMultiplier(Integer rewardMultiplier) {
        this.rewardMultiplier = rewardMultiplier;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(C.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
