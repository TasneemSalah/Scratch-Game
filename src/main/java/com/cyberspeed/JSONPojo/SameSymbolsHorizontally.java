...
public class SameSymbolsHorizontally {
    ...
    public SameSymbolsHorizontally withRewardMultiplier(Integer rewardMultiplier) {
        this.rewardMultiplier = rewardMultiplier;
        return this;
    }
    ...
    public SameSymbolsHorizontally withWhen(String when) {
        this.when = when;
        return this;
    }
    ...
    public SameSymbolsHorizontally withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public SameSymbolsHorizontally withCoveredAreas(List<List<String>> coveredAreas) {
        this.coveredAreas = coveredAreas;
        return this;
    }
    ...
    public SameSymbolsHorizontally withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SameSymbolsHorizontally.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SameSymbolsHorizontally) == false) {
            return false;
        }
        SameSymbolsHorizontally rhs = ((SameSymbolsHorizontally) other);
