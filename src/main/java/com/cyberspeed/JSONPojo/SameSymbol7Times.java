...
public class SameSymbol7Times {
    ...
    public SameSymbol7Times withRewardMultiplier(Integer rewardMultiplier) {
        this.rewardMultiplier = rewardMultiplier;
        return this;
    }
    ...
    public SameSymbol7Times withWhen(String when) {
        this.when = when;
        return this;
    }
    ...
    public SameSymbol7Times withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public SameSymbol7Times withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public SameSymbol7Times withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SameSymbol7Times.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SameSymbol7Times) == false) {
            return false;
        }
        SameSymbol7Times rhs = ((SameSymbol7Times) other);
