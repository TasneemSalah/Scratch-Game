...
public class SameSymbolsDiagonallyRightToLeft {
    ...
    public SameSymbolsDiagonallyRightToLeft withRewardMultiplier(Integer rewardMultiplier) {
        this.rewardMultiplier = rewardMultiplier;
        return this;
    }
    ...
    public SameSymbolsDiagonallyRightToLeft withWhen(String when) {
        this.when = when;
        return this;
    }
    ...
    public SameSymbolsDiagonallyRightToLeft withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public SameSymbolsDiagonallyRightToLeft withCoveredAreas(List<List<String>> coveredAreas) {
        this.coveredAreas = coveredAreas;
        return this;
    }
    ...
    public SameSymbolsDiagonallyRightToLeft withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SameSymbolsDiagonallyRightToLeft.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SameSymbolsDiagonallyRightToLeft) == false) {
            return false;
        }
        SameSymbolsDiagonallyRightToLeft rhs = ((SameSymbolsDiagonallyRightToLeft) other);
