...
public class SameSymbol6Times {
    ...
    public SameSymbol6Times withRewardMultiplier(Integer rewardMultiplier) {
        this.rewardMultiplier = rewardMultiplier;
        return this;
    }
    ...
    public SameSymbol6Times withWhen(String when) {
        this.when = when;
        return this;
    }
    ...
    public SameSymbol6Times withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public SameSymbol6Times withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public SameSymbol6Times withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SameSymbol6Times.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SameSymbol6Times) == false) {
            return false;
        }
        SameSymbol6Times rhs = ((SameSymbol6Times) other);
