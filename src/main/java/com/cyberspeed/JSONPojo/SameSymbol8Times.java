...
public class SameSymbol8Times {
    ...
    public SameSymbol8Times withRewardMultiplier(Integer rewardMultiplier) {
        this.rewardMultiplier = rewardMultiplier;
        return this;
    }
    ...
    public SameSymbol8Times withWhen(String when) {
        this.when = when;
        return this;
    }
    ...
    public SameSymbol8Times withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public SameSymbol8Times withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public SameSymbol8Times withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SameSymbol8Times.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SameSymbol8Times) == false) {
            return false;
        }
        SameSymbol8Times rhs = ((SameSymbol8Times) other);
